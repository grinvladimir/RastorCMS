...
return array(
    ...
    // Rastor_Validate_EqualInputs
    "Strings are not equal" => "Строки не равны",
    
    // Rastor_Validate_EqualPasswords
    "Passwords do not match" => "Пароли не совпадают",
    
    // Rastor_Validate_OldPassword
    "The old password is incorrect" => "Старый пароль введен неверно",
    
    // Rastor_Validate_ValidUser
